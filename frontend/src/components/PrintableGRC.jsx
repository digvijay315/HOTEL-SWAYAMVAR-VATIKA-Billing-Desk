  ...
  return (
    <div className="grc-form-container text-black font-sans relative w-full" style={{ boxSizing: 'border-box' }}>
      ...
      <div className="flex flex-col items-center text-center w-full mb-4 relative">
        <h1 className="text-2xl font-bold tracking-wide">ROYAL MAJESTIC</h1>
        <p className="text-[12px] font-semibold">Near Town Police Station, Dumka Jharkhand-814101</p>
        <p className="text-[12px] font-semibold">PHONE:- +91 9905901361, MOB:- 9905900362</p>
        <p className="text-[11px] font-semibold">E-MAIL:-royalmajesticrana@gmail.com</p>
        
        <h2 className="text-sm font-bold underline mt-1">Guest Registration Card</h2>
